            ...
            <div className="-mx-4 -my-2 overflow-x-auto sm:mx-0 sm:overflow-visible">
                <div className="flex relative z-20 flex-row divide-x my-8">
                    ...
                    <div className="flex relative flex-row pl-5 gap-8">
                        <DropdownFilter type="DROPDOWN" selectedItem={"All"} items={["All", "Laptops"]} isShown={activeFilter === "Category"} resetValue={false} label="Category" onFocus={() => {setActiveFilter("Category")}} onTermChanges={(value) => activeFilterHandler("Category", value)} />
                    </div>
                </div>
